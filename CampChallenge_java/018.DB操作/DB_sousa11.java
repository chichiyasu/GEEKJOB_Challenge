 ...
 */
public class DB_sousa11 extends HttpServlet {
    ...
    String prof_update = "UPDATE profiles SET name = ?,tel = ?,age = ?,birthday = ? where profilesID =?";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            System.out.println("MySQLへ接続出来ました。");
            ...
            db_st = db_con.prepareStatement(prof_update);

            db_st.setString(1, n);
            db_st.setString(2, t);
            db_st.setInt(3, Integer.parseInt(a));
            db_st.setString(4, b);
            db_st.setInt(5, Integer.parseInt(ID));

            int result = db_st.executeUpdate();

            System.out.println("更新結果" + result + "件です。");
